...
class SignUpDemandeur extends StatefulWidget {
  @override
  State<SignUpDemandeur> createState() => _inscriptionState();
}

class _inscriptionState extends State<SignUpDemandeur> {
  String sexe = "";
